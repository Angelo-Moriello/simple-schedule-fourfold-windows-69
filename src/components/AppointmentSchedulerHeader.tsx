...
const AppointmentSchedulerHeader: React.FC = () => {
  ...
  return <div className="rounded-2xl shadow-lg border border-gray-200 p-4 sm:p-6 mb-4 sm:mb-6 bg-gradient-to-r from-gray-50 to-white">
      <div className="flex flex-col lg:flex-row items-center justify-between gap-4 lg:gap-6">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-6 w-full lg:w-auto">
          ...
          <div className="bg-gradient-to-br from-slate-50 to-white rounded-xl p-3 sm:p-4 shadow-sm border border-gray-300">
            <img src="/lovable-uploads/01e5b397-b7ba-48e1-a891-b2bc1d71f3ba.png" alt="Da Capo a Piedi - Estetica & Parrucchieri" className="h-16 sm:h-20 lg:h-24 w-auto object-contain" />
          </div>
          ...
          <div className="flex flex-col justify-center text-center lg:text-left">
            ...
            {/* Subtitle */}
            <p className="text-gray-600 text-sm sm:text-base lg:text-lg font-medium">Da Capo a Piedi
Designed By AM Design</p>
          </div>
        </div>
