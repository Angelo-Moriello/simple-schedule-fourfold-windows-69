...
const AppointmentSchedulerHeader: React.FC<AppointmentSchedulerHeaderProps> = ({
  ...
  return <div className="bg-gradient-to-r from-indigo-900 via-blue-800 to-purple-900 text-white shadow-2xl mb-8 rounded-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-6">
            <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-5 border border-white/30">
              <img src="/lovable-uploads/e3330001-9a6b-4c26-a431-89d19870edfe.png" alt="Beauty Scheduler Logo" className="h-16 w-16 object-contain" />
            </div>
            <div>
              <h1 className="text-5xl font-bold bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent">Da Capo a Piedi</h1>
          ...
          <div className="flex space-x-6">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 min-w-[120px]">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-2xl font-bold text-white">{format(selectedDate, 'dd', {
                    locale: it
                  })}</p>
                  <p className="text-blue-200 text-sm uppercase">{format(selectedDate, 'MMM yyyy', {
                    locale: it
                  })}</p>
                </div>
              </div>
