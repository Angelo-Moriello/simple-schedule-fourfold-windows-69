      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-4 lg:gap-0">
        ...
        <div className="flex items-center justify-center lg:justify-start w-full lg:w-auto">
          <div className="bg-gradient-to-br from-slate-50 to-white rounded-xl p-3 sm:p-4 shadow-sm border border-gray-400">
            <img src="/lovable-uploads/01e5b397-b7ba-48e1-a891-b2bc1d71f3ba.png" alt="Da Capo a Piedi - Estetica & Parrucchieri" className="h-16 sm:h-20 lg:h-28 w-auto object-contain" />
          </div>
        </div>
