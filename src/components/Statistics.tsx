...
import { PieChart, Pie, Cell, ResponsiveContainer, BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, Legend, Area, AreaChart, LabelList } from 'recharts';
...
// Palette di colori elegante e professionale con gradiente 3D
...
// Custom label component for 3D pie chart
...
const Statistics: React.FC<StatisticsProps> = ({ appointments, employees, onBack }) => {
  ...
  // Statistiche per tipo di servizio con percentuali
  ...
  return (
    <div className="space-y-4 sm:space-y-6 lg:space-y-8 p-3 sm:p-4 lg:p-6 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 min-h-screen print:bg-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
        {/* Enhanced 3D Service Distribution Chart */}
